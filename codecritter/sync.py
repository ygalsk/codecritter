"""Bidirectional sync between native Claude Code buddy and Codecritter TUI.
...
def sync_bones_to_tui(state: CodecritterState) -> bool:
...
def sync_tui_to_native(state: CodecritterState) -> bool:
...
def _build_enriched_personality(state: CodecritterState, companion: dict) -> str:
...
def full_sync(state: CodecritterState) -> dict[str, bool]:
